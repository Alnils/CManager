...
/Du måste göra flera pushar till GIT/GITHUB under projektets gång. 
/Det räcker att du pushar till main/master branchen men det ska tydligt framgå att du gjort någon form av progression, 
/vilket betyder att om du gör en metod i din service så ska du när du är klar med den metoden göra en push och ange ett
/vettigt commit meddelande (IT-branchen kräver detta).
